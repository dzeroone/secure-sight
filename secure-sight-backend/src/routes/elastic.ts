...
router.post("/data/search",
  ...
  async (req, res) => {
    try {
      ...
      //             {
      //               "Priority": 3,
      //               "Description": "Incidents that have a minimal impact with the potential for escalation if not contained, causing significant impact on operations.",
      //               "Response_Time": ""
      //             },
      //             {
      //               "Priority": 4,
      //               "Description": "Incidents that do not have a direct impact on customer operations but violate the customer security baseline.",
      //               "Response_Time": ""
      //             }
      //           ]
      //         },
      ...
      //               {
      //                 "Status": "",
      //                 "Product": "TM Cloud One"
      //               },
      //               {
      //                 "Status": "",
      //                 "Product": "TM Vision One"
      //               },
      //               {
      //                 "Status": "",
      //                 "Product": "TM Deep Security"
      //               }
      //             ],
      //             "Products_Connected": [
      //               {
      ...
      //             }
      //           },
      //           "highly_exploitable": 1739,
      //           "Incident_Closed": 0,
      //           "Highest_incidient": 0,
      //           "Highest_incidient_date": null,
      //           "top_incident": {
      //             "no_incidents": 0,
      //             "table": []
      //           },
