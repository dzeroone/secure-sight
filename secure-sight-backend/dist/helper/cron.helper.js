...
class cronScheduler {
  sendMailFn({ id, emailData, schedulingTime, reportIds, dbName }) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const dmReport = yield (0, dynamicModel_1.dynamicModelWithDBConnection)(
        dbName,
        constant_1.COLLECTIONS.REPORT,
      );
      const dmScheduler = yield (0,
      dynamicModel_1.dynamicModelWithDBConnection)(
        mainDb,
        constant_1.COLLECTIONS.SCHEDULER,
      );
      let cronExpression;
      ...
      const abc = (0, node_cron_1.schedule)(
        cronExpression,
        () =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            for (const reportId of reportIds) {
              ...
              if (!report) {
                yield dmScheduler.findOneAndUpdate(
                  { _id: id },
                  {
                    $set: {
              ...
              if (report.type === "report") {
                const reports = yield dmReport
                  .find({ report_id: String(reportId) })
                  .lean();
                if (reports.length > 0) {
                  reports.forEach((dRep) => {
                    ...
                    if (data.length > 0) {
                      const flattenData = (0,
                      reports_helper_1.jsonFlattenObject)(data);
                      const csvFromArrayOfObjects =
                        json2csvParser.parse(flattenData);
                      let attachment = {
                  ...
                  if (!report) {
                    let updateReport = yield dmScheduler.findOneAndUpdate(
                      { _id: id },
                      {
                        $set: {
                          isScheduleActive: false,
              ...
              if (attachments.length > 0) {
                const finalMailData = Object.assign(
  ...
  constructor() {
    ...
    this.schedule = (0, node_cron_1.schedule)(
      "* * * * *",
      () =>
        __awaiter(this, void 0, void 0, function* () {
          const dmScheduler = yield (0,
...
const connectorTestScheduler = (response, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      console.log(
        "-------------------the connetor main file is being executed-----------------",
      );
      const isFileExists = yield fs_1.default.access(
        ...
        (err) => {
          ...
          (0, decompress_1.default)(zipFilePath, serverPath)
            .then((files) => {
              ...
              const job = (0, node_cron_1.schedule)(
                schedulingString,
                () => {
...
const stopTestConnectorScheduler = (connectorId) =>
  __awaiter(void 0, void 0, void 0, function* () {
