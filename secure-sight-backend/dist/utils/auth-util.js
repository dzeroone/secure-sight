  ...
  __awaiter(void 0, void 0, void 0, function* () {
    if ([index_1.OTHER.ROLE2, index_1.OTHER.ROLE3].includes(req.body.role)) {
      const dm = (0, dynamicModel_1.dynamicModelWithDBConnection)(
        index_1.OTHER.MASTER_ADMIN_DB,
        index_1.COLLECTIONS.TENANT,
      );
      ...
      .then((isMatch) => {
        ...
        if (isMatch) {
          jsonwebtoken_1.default.sign(
            params,
            jwtSecret,
            { expiresIn: jwtSignInExpiresIn },
            (err, token) => {
              delete params.password;
              (params.fullname = user.full_name), (params.id = user._id);
              let name =
...
const sendUserDetail = (params) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let response;
    return new Promise((resolve) =>
      __awaiter(void 0, void 0, void 0, function* () {
        const dm = yield (0, dynamicModel_1.dynamicModelWithDBConnection)(
          params.dbName,
          index_1.COLLECTIONS.USERS,
        );
      ...
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (user) {
          ...
          bcryptjs_1.default.genSalt(10, (_err, salt) =>
            __awaiter(void 0, void 0, void 0, function* () {
              bcryptjs_1.default.hash(params.password, salt, (err2, hash) =>
                __awaiter(void 0, void 0, void 0, function* () {
                  if (err2) {
                    resolve({ err2 });
                  } else {
                    ...
                    const response = yield dm.findOne(
                      { email: params.email },
                      { password: 0 },
                    );
                    resolve(response);
