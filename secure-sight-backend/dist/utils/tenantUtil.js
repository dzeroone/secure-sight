...
exports.shareDefaultConnectors =
  exports.createUpdateClientDb =
  exports.createDynamicConnection =
  exports.updateDbName =
    void 0;
const fs = require("fs");
...
const shareDefaultConnectors = (obj, info) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve) =>
      __awaiter(void 0, void 0, void 0, function* () {
        const master = (0, dynamicModel_1.dynamicModelWithDBConnection)(
          info.dbName,
          index_1.COLLECTIONS.CONNECTOR,
        );
        let arr = yield master
          .find(
            {
              role: info.role,
              email: info.email,
        ...
        const tenant_connector = arr.map((val, index) =>
        ...
        const tenant = (0, dynamicModel_1.dynamicModelWithDBConnection)(
          obj.dbName,
          index_1.COLLECTIONS.CONNECTOR,
        );
        for (let index in tenant_connector) {
          ...
          const query = {
            email: obj2.email,
            display_name: obj2.display_name,
            role: index_1.OTHER.ROLE2,
            dbName: obj2.dbName,
          };
