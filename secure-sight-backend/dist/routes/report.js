...
router.post("/add-report-data", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let data = yield reportController_1.default.addReportData(req.body);
    res.send(data);
  }),
);
router.post("/update-reportTable-title", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let data = yield reportController_1.default.updateReportTableTitle(
      req.body,
    );
    res.send(data);
  }),
);
router.post("/get-report-data", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
router.post("/delete-report-data", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let data = yield reportController_1.default.deleteReportData(req.body);
    res.send(data);
  }),
);
router.post("/merge-report", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
