...
const tenantController_1 = __importDefault(
  require("../../controllers/master-admin-controller/tenantController"),
);
router.post("/add-update-tenant", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let data = yield tenantController_1.default.createUpdateTenant(req.body);
    res.send(data);
  }),
);
router.post("/delete-tenant", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
