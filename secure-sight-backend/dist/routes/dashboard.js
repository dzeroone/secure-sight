...
const dashboardController_1 = __importDefault(
  require("../controllers/dashboardController"),
);
router.post("/create-dashboard", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let data = yield dashboardController_1.default.createDashboard(req.body);
    res.send(data);
  }),
);
router.post("/update-dashboard", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
router.post("/delete-dashborad-data", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let data = yield dashboardController_1.default.deleteDashboardData(
      req.body,
    );
    res.send(data);
  }),
