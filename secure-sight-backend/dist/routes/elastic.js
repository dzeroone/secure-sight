...
router.post("/data/", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      switch (test) {
        case "filtering":
          response = yield axios_1.default.post(
          ...
          break;
        default:
          response = yield axios_1.default.get(
            `${esUrl}${req.body.index}/_search?size=10000`,
          );
          break;
      }
...
router.post("/cveSearch", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      let cve = yield axios_1.default.post(
        `${esUrl}${req.body.index1}/_search?size=10000`,
      );
      ...
      let assignedRuleIds = yield axios_1.default.post(
        `${esUrl}${req.body.index2}/_search?size=10000`,
        {
          query: {
            bool: {
              filter: {
      ...
      let unAssignedRuleIds = yield axios_1.default.post(
        `${esUrl}${req.body.index2}/_search?size=10000`,
        {
          query: {
            bool: {
      ...
      const ips = assignedRuleIds.data.hits.hits.concat(
        unAssignedRuleIds.data.hits.hits,
      );
      const ip = ips.map((a) => {
        return a["_source"].comp_id;
      });
      let computer = yield axios_1.default.post(
        `${esUrl}${req.body.index3}/_search?size=10000`,
        {
          query: {
            bool: {
              filter: {
...
router.delete("/index", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      let data = yield axios_1.default.post(
...
router.post("/create-index", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (!ifIndexExist) {
        const esResponse = yield axios_1.default.put(
