...
app.use(
  express_1.default.raw({ type: "application/octet-stream", limit: "100mb" }),
);
// Passport Config
...
const CONNECTION_STRING =
  `${process.env.mongo_base_url}/${process.env.mongo_db}` || "";
mongoose_1.default.connect(CONNECTION_STRING);
mongoose_1.default.connection.once("open", () => {
  console.log(
    `Connection to database has been established successfully ${CONNECTION_STRING}`,
  );
});
