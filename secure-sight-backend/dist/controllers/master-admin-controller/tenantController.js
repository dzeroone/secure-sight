    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (data.check === "add") {
        ...
        if (getEntry && getEntry.companyName === data.companyName) {
          ...
          return {
            msg: `Tenant code (${data.tenantCode}) is already exist!`,
            error: true,
          };
          ...
          return {
            msg: `${data.companyName} created successfully!`,
            error: false,
          };
        }
      } else {
        const check2 = yield dm
          .findOne({ dbName: obj.dbName, tenantCode: obj.tenantCode })
          .lean();
        yield dm.findOneAndUpdate(
          check2,
          Object.assign(Object.assign({}, obj), { updated_at: new Date() }),
        );
        yield (0, tenantUtil_1.createUpdateClientDb)(obj);
        return {
          msg: `${data.companyName} info updated successfully!`,
          error: false,
        };
      }
    });
    ...
    return __awaiter(this, void 0, void 0, function* () {
      return new Promise((resolve) => {
        ...
        let dm = (0, dynamicModel_1.dynamicModelWithDBConnection)(
          constant_1.OTHER.MASTER_ADMIN_DB,
          constant_1.COLLECTIONS.TENANT,
        );
      ...
      return new Promise((resolve, reject) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (user) {
            ...
            const connection = mongoose_1.default.createConnection(url, {
              maxPoolSize: 10,
            });
            ...
            response = {
              success: false,
              status: 400,
              message: "tenant are not present",
              error: true,
            };
            resolve(response);
            return;
