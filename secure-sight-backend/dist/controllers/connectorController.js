...
class ConnectorController {
  createUpdateConnector(params) {
    return __awaiter(this, void 0, void 0, function* () {
      let query = Object.assign(Object.assign({}, params.query), params.info),
        info = params.info;
      const dm = (0, dynamicModel_1.dynamicModelWithDBConnection)(
        info.dbName,
        constant_1.COLLECTIONS.CONNECTOR,
      );
      const obj = yield dm.findOne({
  ...
  insertMultiConnector(params) {
    return __awaiter(this, void 0, void 0, function* () {
      let info = params.info,
        ...
        data = params.data
          .map((p) =>
            Object.assign(Object.assign(Object.assign({}, info), p), {
              created_at: _date,
              updated_at: _date,
            }),
          )
      ...
      for (let index in data) {
        ...
        if (!res) {
          const doc = new dm(
            Object.assign(Object.assign({}, obj), { type: "default" }),
          );
          yield doc.save();
        } else {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      return new Promise((resolve) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          let dm = (0, dynamicModel_1.dynamicModelWithDBConnection)(
            params.info.dbName,
            constant_1.COLLECTIONS.CONNECTOR,
          );
  ...
  activateConnector(params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield dm.findOneAndUpdate(
        { role: info.role, email: info.email, display_name: data.display_name },
        { $set: { status: data.status, userInputs: data.userInputs } },
      );
      return { error: false };
    });
  }
        ...
        if (data) {
          params.data.map((p) =>
            __awaiter(this, void 0, void 0, function* () {
              ...
              const getEntry = yield dm
                .findOne({ connectorId: info._id })
                .lean();
              const query = {
                connectorId: info._id,
                name: info.name,
                role: constant_1.OTHER.ROLE2,
                display_name: info.display_name,
                category: info.category,
                config: info.config,
                actions: info.actions,
                filePath: info.filePath,
                email: `tenant@${p.domain}`,
                dbName: p.dbName,
              ...
              if (!getEntry) {
                ...
                response = {
                  success: true,
                  status: 200,
                  msg: "Connector assign successfully.",
                  error: false,
                };
                resolve(response);
                return;
                ...
                response = {
                  success: false,
                  status: 400,
                  msg: "Connector is already assign to Tenant.",
                  error: true,
                };
                resolve(response);
                return;
    ...
    return __awaiter(this, void 0, void 0, function* () {
      return new Promise((resolve, reject) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const connector = yield dm
            .findOne({ connectorId: info.connectorId })
            .lean();
          if (connector) {
            yield dm.deleteOne({ connectorId: info.connectorId });
            const um = (0, dynamicModel_1.dynamicModelWithDBConnection)(
              info.dbName,
              constant_1.COLLECTIONS.USERCONNECTOR,
            );
            yield um.deleteMany({ connectorId: info.connectorId });
            response = {
              success: true,
              status: 200,
              msg: `Connector delete successfully.`,
            };
            resolve(response);
            return;
          } else {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      return new Promise((resolve, reject) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const dm = (0, dynamicModel_1.dynamicModelWithDBConnection)(
            info.dbName,
            constant_1.COLLECTIONS.TENANT,
          );
          const tenant = yield dm.find().lean();
          tenant.map((p) =>
            __awaiter(this, void 0, void 0, function* () {
              const bm = (0, dynamicModel_1.dynamicModelWithDBConnection)(
                p.dbName,
                constant_1.COLLECTIONS.USERCONNECTOR,
              );
              yield bm.deleteMany({ connectorId: info.connectorId });
              const cm = (0, dynamicModel_1.dynamicModelWithDBConnection)(
                p.dbName,
                constant_1.COLLECTIONS.CONNECTOR,
              );
          ...
          const gm = (0, dynamicModel_1.dynamicModelWithDBConnection)(
            info.dbName,
            constant_1.COLLECTIONS.CONNECTOR,
          );
        ...
        if (data) {
          params.data.map((p) =>
            __awaiter(this, void 0, void 0, function* () {
              ...
              const getEntry = yield dm
                .findOne({
                  $and: [{ user_id: p._id }, { connectorId: info.connectorId }],
                })
                .lean();
              if (!getEntry) {
                const query = Object.assign(
                  Object.assign({ user_id: p._id }, info),
                  { role: constant_1.OTHER.ROLE3 },
                );
                const doc = new dm(
                  Object.assign(Object.assign({}, query), {
                    created_at: new Date(),
                ...
                response = {
                  success: true,
                  status: 200,
                  msg: "Connector assign to user successfully.",
                  error: false,
                };
                resolve(response);
                return;
                ...
                response = {
                  success: true,
                  status: 400,
                  msg: "Connector is already asign to user.",
                  error: true,
                };
                resolve(response);
                return;
        ...
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (list.length > 0) {
            ...
            response = {
              success: false,
              status: 404,
              msg: `User connector list not found.`,
            };
            resolve(response);
            return;
          }
      ...
      return new Promise((resolve) =>
        __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            let { config, connectorBasePath, connectorFileNameWithExtension } =
              data;
            if (
              !config ||
              !connectorBasePath ||
              !connectorFileNameWithExtension
            ) {
              response = {
                success: false,
                status: 404,
            ...
            const dbConnection = yield (0,
            dynamicModel_1.dynamicModelWithDBConnection)(
              dbName,
              constant_1.COLLECTIONS.CONNECTOR_CONFIG,
            );
            const configData = Object.assign(
              Object.assign(
                {
                  connectorId: new mongoose_1.default.Types.ObjectId(
                    connectorId,
                  ),
                },
                data,
            ...
            if (isConnectorConfigExist.length > 0) {
              const insertConfigInToCollection =
                yield dbConnection.findOneAndUpdate(
                  ...
                  {
                    $set: Object.assign(Object.assign({}, configData), {
                      createdAt: undefined,
                    }),
                  },
                );
          ...
          if (isScheduled) {
            ...
            if (connectorData && connectorData.hasOwnProperty("config")) {
              ...
              configDataKeys.forEach((configKey) => {
                const isKeyExists = Object.keys(data.config).includes(
                  configKey,
                );
                if (!isKeyExists) {
                  response = {
              ...
              yield (0, cron_helper_1.connectorTestScheduler)(
                responseData,
                dataScheduler,
              );
              yield dbConnection.findOneAndUpdate(
            ...
            let isStopped = yield (0, cron_helper_1.stopTestConnectorScheduler)(
              connectorId,
            );
            response = isStopped
              ? {
