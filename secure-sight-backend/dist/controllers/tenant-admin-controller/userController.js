...
class UserController {
      ...
      return new Promise((resolve) => {
        bcryptjs_1.default.genSalt(10, (_err, salt) =>
          __awaiter(this, void 0, void 0, function* () {
            bcryptjs_1.default.hash(query.password, salt, (err2, hash) =>
              __awaiter(this, void 0, void 0, function* () {
                if (err2) {
                  resolve("");
                } else {
  ...
  addUpdateUser(params) {
    return __awaiter(this, void 0, void 0, function* () {
      return new Promise((resolve) =>
        __awaiter(this, void 0, void 0, function* () {
          let query = Object.assign(Object.assign({}, params.query), {
              tenantCode: params.info.tenantCode,
              dbName: params.info.dbName,
            }),
            info = params.info;
          let dm = (0, dynamicModel_1.dynamicModelWithDBConnection)(
            info.dbName,
            constant_1.COLLECTIONS.USERS,
          );
          ...
          if (query.check === "add") {
            ...
            if (!user) {
              ...
              yield doc.save();
              resolve({
                msg: `${query.email} created successfully`,
                error: false,
              });
            } else {
  ...
  deleteUser(params) {
    return __awaiter(this, void 0, void 0, function* () {
      return new Promise((resolve) => {
        ...
        let user = dm
          .findOne({ tenantCode: params.tenantCode, email: params.email })
          .lean();
        if (user) {
