        ...
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (getEntry && getEntry.reportName === data.reportName) {
            response = {
              success: false,
              status: 409,
              msg: `${data.reportName} report is already exits`,
            };
            resolve(response);
            return;
          } else {
            ...
            response = {
              success: true,
              status: 200,
              msg: `${data.reportName} report created successfully.`,
            };
            resolve(response);
            return;
          }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return new Promise((resolve) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const report = yield dm
            .find({ $and: [{ user_id: params.user_id }, { type: "report" }] })
            .lean();
          if (report.length > 0) {
            response = {
              success: true,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return new Promise((resolve) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const report = yield dm
            .find({ $and: [{ _id: info.id }, { user_id: info.user_id }] })
            .lean();
          if (report.length > 0) {
            ...
            response = {
              success: true,
              status: 200,
              msg: `User report delete successfully.`,
            };
            resolve(response);
            return;
          } else {
        ...
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (getEntry) {
            ...
            response = {
              success: true,
              status: 200,
              msg: `${info.title} table created successfully`,
              error: false,
            };
            resolve(response);
            return;
            ...
            response = {
              success: false,
              status: 400,
              msg: `${info.title} table failed to created`,
              error: true,
            };
            resolve(response);
            return;
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return new Promise((resolve) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const getEntry = yield dm
            .find({
              $and: [{ report_id: data.report_id }, { user_id: data.user_id }],
            })
            .lean();
          if (getEntry) {
            response = {
              ...
              status: 200,
              data: getEntry,
              msg: `Get report data successfully.`,
              error: false,
            };
            resolve(response);
            return;
        ...
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (report) {
            response = {
              success: true,
              status: 200,
              msg: `report data delete succeassfully.`,
            };
            resolve(response);
            return;
          } else {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return new Promise((resolve) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const report = yield dm.findOneAndUpdate(
            { _id: info.report_id, user_id: info.user_id },
          ...
          if (report) {
            response = {
              success: true,
              status: 200,
              msg: `User report name updated successfully.`,
            };
            resolve(response);
            return;
          } else {
        ...
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (report) {
            response = {
              success: true,
              status: 200,
              msg: `User table name updated successfully.`,
            };
            resolve(response);
            return;
          } else {
        ...
        __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            ...
            for (let i = 0; i < finalDataToBeConvert.length; i++) {
              let flatData = yield (0, reports_helper_1.jsonFlattenObject)(
                finalDataToBeConvert[i],
              );
