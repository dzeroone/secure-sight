...
const WorkbenchIncidentSummaryForm = () => {
  const data = useAppSelector(
    (state) => state.monthlyReport.workbench_incident_summary
  );
  ...
  const handleChange = (field: string, value: string | number) => {
    dispatch(updateWISField({ path: field, value }));
  };
  const handleVisibilityChange = (value: boolean) => {
    dispatch(updateWISvisibility(value));
  };
  return (
...
export default WorkbenchIncidentSummaryForm;
